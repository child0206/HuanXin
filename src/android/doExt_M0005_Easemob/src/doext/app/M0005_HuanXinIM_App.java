 ...
 * 
 */
public class M0005_HuanXinIM_App implements DoIAppDelegate {

	private static final String TAG = "M0005_HuanXinIM_App";
	private static M0005_HuanXinIM_App instance;
	private Context currentContext;

	private M0005_HuanXinIM_App() {
	...
	public static M0005_HuanXinIM_App getInstance() {
		if (instance == null) {
			instance = new M0005_HuanXinIM_App();
		}
		return instance;
	}
