 ...
 *
 */
public class PasteEditText extends EditText implements DoIModuleTypeID{
...
//                intent.setDataAndType(Uri.fromFile(new File("/sdcard/mn1.jpg")), "image/*");     
                ...
                String str = context.getResources().getString(DoResourcesHelper.getIdentifier("Send_the_following_pictures", "string", this));
