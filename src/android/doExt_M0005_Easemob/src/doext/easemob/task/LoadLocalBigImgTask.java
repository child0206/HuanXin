...
import doext.easemob.ui.photoview.PhotoView;
import doext.easemob.util.ImageCache;

public class LoadLocalBigImgTask extends AsyncTask<Void, Void, Bitmap> implements DoIModuleTypeID{
	...
	protected void onPostExecute(Bitmap result) {
		...
		if (result != null)
			...
			result = BitmapFactory.decodeResource(context.getResources(),
					DoResourcesHelper.getIdentifier("signin_local_gallry", "drawable", this));
