...
import doext.define.M0005_HuanXinIM_IMethod;
 ...
 */
public class M0005_HuanXinIM_Model extends DoSingletonModule implements M0005_HuanXinIM_IMethod{
	
	private Context mContext;
	
	public M0005_HuanXinIM_Model() throws Exception {
		super();
	...
	public void login(DoJsonNode _dictParas, final DoIScriptEngine _scriptEngine,final String _callbackFuncName) throws Exception {
		String username = _dictParas.getOneText("username", "");
